                    ...
                    <div className="row">
                      <div className="col-lg-5">
                        ...
                        <div className="case-study-analytics d-flex gap-3">
                          ...
                          <Link href="/leading-indian-bank-transforms-document-translation-workflow-with-ocr-and-automation" className="white">
                    ...
                    <div className="row">
                      <div className="col-lg-5">
                        ...
                        <div className="case-study-analytics d-flex gap-3">
                          ...
                          <Link href="/prestigious-tech-institute-of-india-delivers-video-lectures-4x-faster-in-multiple-languages" className="white">
                        <button type="btn" className="devnagri-btn mt-5">
                            View Case Studies
                    ...
                    <div className="row">
                      <div className="col-lg-5">
                        ...
                        <div className="case-study-analytics d-flex gap-3">
                          ...
                          <Link href="/devnagri-ai-empowered-leading-nbfc-institution-with-ideal-document-translation-solutions" className="white">
                        <button type="btn" className="devnagri-btn mt-5">
                            View Case Studies                          
                          </button></Link>
                      </div>
                  ...
                  <div className="carousel-item">
                    <div className="row">
                      <div className="col-lg-5">
                        ...
                        <Link href="/a-midsized-indian-b2c-company-realizes-regional-growth-through-multilingual-collateral-translation" className="white">
                        <button type="btn" className="devnagri-btn mt-5">
                            View Case Studies
                        </button></Link>
                      </div>
                  ...
                  <div className="carousel-item">
                    <div className="row">
                      <div className="col-lg-5">
                        ...
                        <Link href="/a-government-organization-trained-language-model-with-chinese-hindi-translation" className="white">
                        <button type="btn" className="devnagri-btn mt-5">
                            View Case Studies
                        </button></Link>
                      </div>
                    ...
                    <div className="row">
                      <div className="col-lg-5">
                        ...
                        <div className="case-study-analytics d-flex gap-3">
                          ...
                          <Link href="/how-dota-is-revolutionizing-language-translation-in-the-digital-age" className="white">
                        <button type="btn" className="devnagri-btn mt-5">
                            View Case Studies
                        </button></Link>
                      </div>
